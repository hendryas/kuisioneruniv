...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url('assets2/img/logo-umb.png') ?>" />
  <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('assets2/img/logo-umb.png') ?>" />
